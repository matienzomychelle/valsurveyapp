  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-primary/5 py-8 px-4">
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        <div className="bg-gradient-to-r from-primary to-primary/90 text-primary-foreground py-6 px-6 rounded-t-lg shadow-lg flex items-center gap-4">
        ...
        {/* Content */}
        <div className="bg-card shadow-2xl rounded-b-lg p-8 md:p-12">
